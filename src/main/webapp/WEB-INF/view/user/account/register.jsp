...
<%@include file="/WEB-INF/view/layout/user/taglib.jsp"%>
		...
		<div class="span4">
			...
			<form:form action="dang-ky" method="POST" modelAttribute="user">  
			  <div class="control-group">
				...
				<label class="control-label" for="inputPasswordu">Mật khẩu</label>
				<div class="controls">
				   <form:input type="password" class="span3" placeholder="Mời nhập mật khẩu" path="password" />  
				</div>
				<label class="control-label" for="inputHovaten">Họ và tên</label>
				<div class="controls">
				  <form:input type="Hovaten" class="span3" placeholder="Mời nhập họ và tên" path="display_name" />
				</div>
				<label class="control-label" for="inputDiachi">Địa chỉ</label>
				<div class="controls">
				 <form:input type="Diachi" class="span3" placeholder="Mời nhập địa chỉ" path="address" />
				</div>
			  </div>
			  <div class="controls">
